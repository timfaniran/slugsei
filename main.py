...
# Function to trim the first 5 seconds of the video
...
# Function to analyze the first detected person and show pose in real-time
    ...
    with mp_pose.Pose(static_image_mode=False, min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                frame_data = [frame_count]  # Start with frame index
...
for file in csv_files:
    ...
    for idx, video_url in enumerate(df["video"]):
        ...
        # Trim video to the first 5 seconds
        trimmed_path = trim_video(local_video_path, trimmed_video_path)
        if not trimmed_path:
            continue

        # Analyze first person detected and visualize pose
