...
if __name__ == "__main__":
    # Sample Testing: Only 1 vid so far, need train & test bunch of vids from csv to get better model
    video_file = "datasets/videos/video_0.mp4" 
    ball_positions = track_baseball(video_file, max_seconds=5)  

    with open("ball_positions.txt", "w") as f:
